<template>
  ...
  >
    ...
    <CardWrapperVar2 :unwrap="!isMobile">
      <BlockMainColumns>
        <template #left>
          <BaseTitle
            class="sm:font-secondary font-extrabold sm:font-normal sm:uppercase"
            level="1"
          >
            <span
              class="v-html-styles sm:text-fs-h2"
              v-html="title"
            />
          </BaseTitle>
          <BaseTitle
...
<script setup lang="ts">
  ...
  import CardWrapperVar2 from '~/components/shared/Card/CardWrapperVar2.vue'
  import BlockMainColumns from '~/components/shared/BlockMain/BlockMainColumns.vue'
